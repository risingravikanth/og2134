 ...
 angular.module('OGAnalysis').controller('PipelinesDomesticCtrl', function($scope,$state,$rootScope,URL,HttpService,$timeout) {
	console.log("In PipelinesDomesticCtrl ctrl");
 	console.log($state)
	
 	$scope.setConfigurations = function(){
	 		$scope.url = "/pipeline/domestic/length";
