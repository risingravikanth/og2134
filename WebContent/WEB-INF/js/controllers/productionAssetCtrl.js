 ...
 angular.module('OGAnalysis').controller('ProductionAssetCtrl', function($scope,$state,$rootScope,URL,HttpService,$timeout) {
	console.log("In ProductionAssetCtrl");
 	console.log($state)
	
 	$scope.setConfigurations = function(){
	 		$scope.url = "/production/asset";
			$rootScope.filterObj = {
				regionField :true,
				countryField :true,
				locationField : false,
